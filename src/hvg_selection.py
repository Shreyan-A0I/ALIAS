...
def robust_hvg_selection(h5_paths):
    """
    ...
    # Extract top 10 visually descriptive genes
    top_hvgs = target_adata.var[target_adata.var['highly_variable']].sort_values(by="dispersions_norm", ascending=False).index[:10].tolist()
